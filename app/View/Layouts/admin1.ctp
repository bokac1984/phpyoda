...
<html lang="en">
  ...
  <body style="">
          ...
          <ul class="nav navbar-nav pull-right">   
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><?php echo $this->Link->cLink("Manage", array('plugin' => null, 'controller' => 'users', 'action' => 'index'), 'cog'); ?></li>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-xs-3 col-sm-2 menu-sidebar" id="sidebar" role="navigation">
